...
def main():
    ...
    simple_arkanoid_log_file_name ='arkanoid_log_2025_02_07_16_06_40.pkl' #'reconstructed_log.pkl'  |'arkanoid_log_2025_10_10_11_20_52.pkl' | 'reconstructed_log_clean.pkl'
    ...
    print("qui prima")
    summarize_into_prototypes(population[0][1], True)
