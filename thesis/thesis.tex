...
•	A Pong-like environment with ball and two paddles.
...
•	Full Environment: ball, paddle, bricks.
...
•	Arkanoid:
o	Baseline Arkanoid with 24 bricks.
o	Modified Arkanoid versions for generalization testing:
-	Increased ball size,
-	Increased number of bricks,
-	Altered visual properties (colors).
•	Pong, environment for cross-domain validation.
Each RL configuration was trained for up to 5000 episodes, with periodic checkpoint evaluation over 100 test episodes per model.
