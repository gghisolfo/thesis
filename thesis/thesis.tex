...
Each frame is resized to a fixed resolution of $128 \times 128$ pixels to ensure a consistent input size for the neural network and is converted into a normalized tensor to facilitate stable training. 
